...
#start 
root=Tk()
root.title(" VIRTUAL COIN TAP - GAME ")
root.geometry("350x250")

def home_page():
    global main_frame
    main_frame=Frame(root,width=350,height=250,bg="pink")
    main_frame.pack(fill="both",expand=1)
    l1=Label(main_frame,text=" VIRTUAL COIN TAP GAME - HAND GESTURE ",bg="pink",fg="white",font=("times new roman",12,"bold"))
    l1.grid(row=0,column=0,pady=70)
    b=Button(main_frame,text=" start game ",command=fun,width=10,bg="white",fg="pink",font=("times new roman",20,"bold"))
    b.grid(row=2,padx=10)
